  ...
  async function loadData() {
    ...
    try {
      const [refRes, logsRes, requestsRes, progressRes, issuesRes] = await Promise.all([
        ...
        getJson<DailyLogRow[]>('/site/daily-logs?limit=30'),
        getJson<MaterialRequestRow[]>('/site/material-requests?limit=30'),
        getJson<ProgressRow[]>('/site/progress?limit=30'),
        getJson<IssueRow[]>('/site/equipment-issues?limit=30')
      ]);
