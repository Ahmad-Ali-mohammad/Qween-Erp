...
export const env = {
  ...
  fileStorageDriver: process.env.FILE_STORAGE_DRIVER === 's3' ? 's3' : 'local',
  fileStoragePath: process.env.FILE_STORAGE_PATH ?? './storage/files',
  fileStorageS3Bucket: process.env.FILE_STORAGE_S3_BUCKET ?? '',
  fileStorageS3Region: process.env.FILE_STORAGE_S3_REGION ?? '',
  fileStorageS3Endpoint: process.env.FILE_STORAGE_S3_ENDPOINT ?? '',
